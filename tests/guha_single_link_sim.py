...
def calc_elementary_link_success(l, N, m, alpha, eta_e, P_e, P_emission):
    ...
    A_e = (single_pair_det_prob) + P_e * (1 - (single_pair_det_prob))
    # prob at least 1 photon is detected
    B_e = 1 - (1 - P_e) * (1 - (single_pair_det_prob))**2
    ...
    P_s0 = 4 * s1
    # prob of success BSM of at least 1 of M freqs
    P_s1 = 1 - (1 - P_s0)**m

    print(a_e, b_e, c_e, s1)
    # fidelity calc
